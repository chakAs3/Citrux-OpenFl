...
import citrux.utils.LoadManager;
...
/**
    ...
    var _viewObjects:Dictionary = new Dictionary();
    var _root:Dynamic;
    var _viewInterface:Class;
...
/**
    ...
    public function new(root:Dynamic, viewInterface:Class) {
        _root = root;
...
/**
    ...
    public function addArt(citrusObject:Object):void {
        ...
        if (art["content"] == null)
            loadManager.add(art, cast(citrusObject, CitrusObject));
...
/**
    ...
    public function getArt(citrusObject:Object):Object {
        if (!Std.is(citrusObject, _viewInterface))
            throw new Error("The object " + citruxObject + " does not have a graphical counterpart because it does not implement " + _viewInterface + ".");
...
/**
    ...
    function createArt(citrusObject:Object):Object {
        return null;
    }
...
/**
    ...
    function updateArt(citrusObject:Object, art:Object):Void {
