...
import citrux.input.Input;
import citrux.sounds.SoundManager;
import citrux.utils.AGameData;
import citrux.utils.LevelManager;
...
/**
    ...
    var _stateTransitionning:IState;
    var _futureState:IState;
    var _stateDisplayIndex:uint = 0;
...
/**
    ...
    public function new() {
        ...
        onPlayingChange = new Signal(Bool);
...
/**
    ...
    public function set_state(value:IState):void {
        _newState = value;
    }
...
/**
    ...
    function handleStageFullscreen(e:FullScreenEvent):void {
...
/**
    ...
    function handlePlayingChange(value:Boolean):void {
        if (input)
            input.resetActions();
