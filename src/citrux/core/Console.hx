...
/**
		 ...
		 */
    public function get_onShowConsole():Signal
    {
...
/**
		 ...
		 */
    public function get_onHideConsole():Signal
    {
...
/**
		 ...
		 */
    public var enabled(get_enabled,set_enabled):Void ;
        ...
        if (event.keyCode == _executeKey)
        {
            ...
            if (func != null)
            {
                ...
                catch(e:ArgumentError)
                {
                    ...
                    {
                        trace(e.message);
                        var expected:Float = e.message.slice(e.message.indexOf("Expected ") + 9, e.message.lastIndexOf(","));
